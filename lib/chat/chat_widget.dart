...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await actions.updateChatCollection1(
        currentUserEmail,
      );
    });
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ListaChatRecord>>(
      stream: queryListaChatRecord(
        queryBuilder: (listaChatRecord) => listaChatRecord.where(
          'email',
      ...
      builder: (context, snapshot) {
        ...
        List<ListaChatRecord> chatListaChatRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final chatListaChatRecord = chatListaChatRecordList.isNotEmpty
            ? chatListaChatRecordList.first
            : null;
                                ...
                                Expanded(
                                  child: FlutterFlowDropDown<String>(
                                    ...
                                    onChanged: (val) async {
                                      ...
                                      if (_model.dropDownValue == 'Limpar') {
                                        await actions
                                            .updateOrDeleteChatCollection(
                                          currentUserEmail,
                                        );
                                        safeSetState(() {
                                          _model.dropDownValueController
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        if (_model.textController.text == '') {
                                          ...
                                          _model.saidaaaaaaaaaaaaaaaaaaaa =
                                          ...
                                          await chatListaChatRecord!.reference
                                              .update(createListaChatRecordData(
                                            novaMensagem: true,
                                          ));
                                          _model.listaChat =
                                              await queryListaChatRecordOnce(
                                          ...
                                          if (_model.listaChat?.email == null ||
                                              _model.listaChat?.email == '') {
