...
class _CadastroWidgetState extends State<CadastroWidget>
  ...
  void initState() {
    ...
    _model.cnpjoucpfTextController ??= TextEditingController();
    _model.cnpjoucpfFocusNode ??= FocusNode();
    _model.cnpjoucpfFocusNode!.addListener(() => safeSetState(() {}));
    _model.cnpTextController ??= TextEditingController();
    _model.cnpFocusNode ??= FocusNode();
    _model.cnpFocusNode!.addListener(() => safeSetState(() {}));
    _model.cnpMask = MaskTextInputFormatter(mask: '##.###.###/####-##');
    _model.tipodecontratoTextController ??= TextEditingController();
    _model.tipodecontratoFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsuariosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuariosRecord> cadastroUsuariosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final cadastroUsuariosRecord = cadastroUsuariosRecordList.isNotEmpty
            ? cadastroUsuariosRecordList.first
            : null;
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [Color(0xE64B39EF), Color(0xFFF5F5F5)],
                        stops: [0.0, 1.0],
                                    ...
                                    onChanged: (newValue) async {
                                      ...
                                      if (newValue!) {
                                        if (_model.checkboxValue!) {
                                          await action_blocks.sad(context);
                                        }
                                      }
                                    },
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (selectedMedia != null &&
                                        ...
                                        try {
                                          ...
                                          _model.isDataUploading_uploadData5oj =
                                              false;
                                        }
                                        if (selectedUploadedFiles.length ==
                                            ...
                                            downloadUrls.length ==
                                                selectedMedia.length) {
                                          safeSetState(() {
                                            _model.uploadedLocalFile_uploadData5oj =
                                                selectedUploadedFiles.first;
                                            _model.uploadedFileUrl_uploadData5oj =
                                                downloadUrls.first;
                                          });
                                        } else {
                                          safeSetState(() {});
                                ...
                                if (_model.logicaVisivel.toString() == '1')
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 6.0, 0.0, 6.0),
                                    child: Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText: _model.checkboxValue == true
                                            ? 'Email da empresa'
                                            : 'email do usuário',
                                ...
                                if (_model.checkboxValue == false)
                                  Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.cnpjoucpfTextController,
                                      focusNode: _model.cnpjoucpfFocusNode,
                                      ...
                                      validator: _model
                                          .cnpjoucpfTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                if (_model.checkboxValue == true)
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      keyboardType: TextInputType.number,
                                      validator: _model
                                          .cnpTextControllerValidator
                                          .asValidator(context),
                                      inputFormatters: [_model.cnpMask],
                                    ),
                                  ),
                                if (_model.checkboxValue == true)
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.tipodecontratoTextController,
                                        focusNode:
                                            _model.tipodecontratoFocusNode,
                                        autofocus: true,
                                        autofillHints: [AutofillHints.email],
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          ...
                                          onPressed: () async {
                                            ...
                                            await usuariosRecordReference
                                              ...
                                              displayName: _model
                                                  ...
                                                  .text,
                                              photoUrl: _model
                                                  .uploadedFileUrl_uploadData5oj,
                                              senha: _model
                                                  .passwordTextController.text,
                                              empresa: _model.checkboxValue,
                                              tipodecontrato: _model
                                                  .tipodecontratoTextController
                                                  .text,
                                              cnpj: _model
                                                  .cnpjoucpfTextController.text,
                                            ));
                                            _model.joj = UsuariosRecord
                                                .getDocumentFromData(
                                            ...
                                            FFAppState().variavelUSUARIO =
                                              ...
                                              email: _model
                                                  .emailAddressTextController
                                                  .text,
                                              referencia: cadastroUsuariosRecord
                                                  ?.reference,
                                            );
                                            safeSetState(() {});
                                            await showDialog(
