...
import '/components/logininicial_widget.dart';
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (_) => EasyDebounce.debounce(
                                ...
                                () async {
                                  _model.tex = await actions.miuscula(
                                    _model.textController.text,
                                  );
                                  safeSetState(() {
                                    _model.textController?.text = _model.tex!;
                                  });
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Atenção'),
                                        content: Text(
                                            'Preecha todos os campos para continuar.'),
                                        actions: [
                                          TextButton(
