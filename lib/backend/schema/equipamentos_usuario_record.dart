...
class EquipamentosUsuarioRecord extends FirestoreRecord {
  EquipamentosUsuarioRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('equipamentos_usuario');

  static Stream<EquipamentosUsuarioRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => EquipamentosUsuarioRecord.fromSnapshot(s));

  static Future<EquipamentosUsuarioRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => EquipamentosUsuarioRecord.fromSnapshot(s));

  static EquipamentosUsuarioRecord fromSnapshot(DocumentSnapshot snapshot) =>
      EquipamentosUsuarioRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static EquipamentosUsuarioRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      EquipamentosUsuarioRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'EquipamentosUsuarioRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is EquipamentosUsuarioRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createEquipamentosUsuarioRecordData({
  String? equipamento,
  String? marca,
  String? modelo,
  String? btus,
...
class EquipamentosUsuarioRecordDocumentEquality
    implements Equality<EquipamentosUsuarioRecord> {
  const EquipamentosUsuarioRecordDocumentEquality();

  @override
  bool equals(EquipamentosUsuarioRecord? e1, EquipamentosUsuarioRecord? e2) {
  ...
  @override
  int hash(EquipamentosUsuarioRecord? e) => const ListEquality().hash([
        e?.equipamento,
        e?.marca,
        e?.modelo,
        e?.btus,
  ...
  @override
  bool isValidKey(Object? o) => o is EquipamentosUsuarioRecord;
}
